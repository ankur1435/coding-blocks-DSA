...
//		// 2. case
        ...
        // // Members in C (like d2) are not accessible unless the object is explicitly cast to type C.
        // System.out.println(obj.d);  // Accesses 'd' from P
        // System.out.println(obj.d1); // Accesses 'd1' from P
        // // System.out.println(obj.d2); // Compile-time error: 'd2' is not defined in P
...
//		// 3. case
		// C obj = new P();
		// // This case will not compile because P is the superclass of C, and you cannot assign a parent type (P) object to a child type (C) reference without explicit casting.
...
// Definition: Runtime polymorphism (or dynamic polymorphism) occurs when a method call to an overridden method is resolved at runtime, based on the actual object type.
// Key Points:
// 1: It applies only to methods, not to data members.
// 2: The method that gets executed depends on the actual object type (C here) and not the reference type (P).
